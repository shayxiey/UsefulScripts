      seqfile = ../alns/42/GALGAL_R08070.c12.ginsi.42.fa  * sequence data filename
      treefile = ../trees/42.mapping.new * tree file name

      outfile = ../out/42.R08070.0.result           * main result file name
   ...
   aaRatefile = ../dat/wag.dat * for aa seqs under model = 3 (empirical+F)
    ...
    fix_omega = 0  * 1: omega or omega_1 fixed, 0: estimate
        omega = 0.1  * initial or fIf yoixed omega, for codons or codon-based AAs
